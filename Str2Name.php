...
class Str2Name {
  ...
  /**
   * Transliteration map from accented characters to their ASCII equivalents.
   *
   * Deliberately public: the table is part of the API surface, so consumers
   * can inspect the transliteration coverage.
   */
